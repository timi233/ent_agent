...
def test_repositories():
    ...
    try:
        from infrastructure.database.repositories.fully_standalone_repository import (
            FullyStandaloneRepository, 
            FullyStandaloneCustomerRepository, 
            FullyStandaloneEnterpriseRepository
        )
        
        # 创建仓储实例
        customer_repo = FullyStandaloneCustomerRepository()
        enterprise_repo = FullyStandaloneEnterpriseRepository()
        print("✓ 完全独立仓储层导入成功")
...
def test_integration():
    ...
    try:
        ...
        from infrastructure.database.repositories.fully_standalone_repository import FullyStandaloneCustomerRepository
        
        settings = get_settings()
        customer_repo = FullyStandaloneCustomerRepository()
        
        print("✓ 配置和完全独立仓储层集成成功")
...
def test_functionality():
    ...
    try:
        ...
        from config.simple_settings import get_settings
        settings = get_settings()
        logger.info(f"配置测试 - 数据库: {settings.database.host}:{settings.database.port}")
        print("✓ 配置功能测试通过")
